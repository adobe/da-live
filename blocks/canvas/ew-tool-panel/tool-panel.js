    ...
    return html`
      <div class="tool-panel-header">
        ...
        <nx-picker
          ...
          size="m"
          style="--nx-picker-section-font-size: var(--s2-component-s-regular-font-size); --nx-picker-section-line-height: var(--s2-component-s-regular-line-height); --nx-picker-section-color: light-dark(var(--s2-gray-600), var(--s2-gray-700)); --nx-picker-item-color: var(--s2-gray-900);"

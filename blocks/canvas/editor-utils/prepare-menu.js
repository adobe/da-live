...
const OOTB_ACTIONS = [
  {
    ...
    render: async (details) => {
      const { loadDefaultPreflightProviders } = await import('../../edit/da-prepare/actions/preflight/providers/index.js');
      await loadDefaultPreflightProviders();
      return (await import('../../edit/da-prepare/actions/preflight/preflight.js')).default(details);
    },
